...
Theorem andb_true_l : forall a : bool, andb true a = a.
Proof.
  intros.
  reflexivity.
Qed.

Theorem andb_false_l : forall a : bool, andb false a = false.
Proof.
  intros.
  reflexivity.
Qed.
...
Proof.
  ...
  destruct b.
  - apply H.
  - rewrite -> andb_false_l in H. destruct c.
    + reflexivity.
    + assumption.
Qed.
(** [] *)
